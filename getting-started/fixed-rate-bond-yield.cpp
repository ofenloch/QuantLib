/**
 * @file fixed-rate-bond-yield.cpp
 ...
 * A copy is in file code-1-3.cpp.
 *
 */
...
int main(int argc, char* argv[]) {
    try {
        ...
        // see zero-bond-yield.cpp for a detailed description of bon parameters
